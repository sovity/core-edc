...
public abstract class AbstractEndToEndTransfer {
    ...
    void httpPull_dataTransfer() {
        ...
        var msg = Generators.timeBasedGenerator().generate().toString();
    ...
    private void createResourcesOnProvider(String assetId, JsonObject contractPolicy, Map<String, Object> dataAddressProperties) {
        ...
        PROVIDER.createContractDefinition(assetId, Generators.timeBasedGenerator().generate().toString(), accessPolicyId, contractPolicyId);
    }
